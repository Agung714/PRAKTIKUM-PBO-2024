...
public final class Main {
    ...
    public static Admin MyAdmin = new Admin("1", "1", priv1, DataBarang);
    public static User user1 = new User("2", "2", priv2, DataBarang);
    // public static akun akun = new akun("2", "2",DataBarang);
