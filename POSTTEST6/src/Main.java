...
import java.io.*;
import java.util.*; 
// package PBO.Praktikum.POSTTEST6.src
public final class Main {
    ...
    private static final String priv1 = "Admin";
    private static final String priv2 = "user";
    public static Admin MyAdmin = new Admin("1", "1", priv1, DataKuliner,DataPakaian);
    public static User user1 = new User("2", "2", priv2, DataKuliner,DataPakaian);
    // public static akun akun = new akun("2", "2",DataKuliner,DataPakaian);
    ...
    private static void login_user() throws NumberFormatException, IOException {
        ...
        System.out.print("Masukkan Password : ");
        String passp = input.readLine();
            if (user1.getUsername().equals(userp)) {
                if (user1.getPass().equals(passp)) {
